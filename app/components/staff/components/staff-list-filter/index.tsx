       ...
       <div className='w-full h-40 flex justify-center items-start'>
         <div style={{
            ...
            <div className="flex justify-center items-center w-full space-x-2 mb-2">
                ...
                <button className="bg-[#F9F8FF] text-[#413753] px-4 py-[2px] rounded-md">Event Helper</button>
                <button className="bg-[#F9F8FF] text-[#413753] px-4 py-[2px] rounded-md">Waiter</button>
