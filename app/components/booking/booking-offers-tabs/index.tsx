                                ...
                                <div className='flex justify-center items-center gap-[88px]'>
                                    <div className='flex gap-[20px]'>
                                        ...
                                        <div className='relative top-[8px]'>
                                            ...
                                            <div className='flex justify-between w-full gap-[136px] items-center'>
                                    ...
                                    <div>
                                        ...
                                        <div className='cursor-pointer flex justify-center items-center'>
                                            ...
                                            </span >  <span className='text-[12px] text-[#2C2240] leading-[18px] tracking-[-0.12px] font-[400] text-center'>Cost Breakdown</span>
                                        </div>
                                    </div>
                                </div>
