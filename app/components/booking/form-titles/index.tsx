...
const FormTitles: React.FC<FormTitlesProps> = ({ styles, currentStep }) => {
    ...
    return (
        <div className={`${styles.tell_us} text-center text-[#000000] flex justify-center items-center gap-[20px] leading-[20.4px] tracking-[-0.32px] !text-[16px] px-[10px] ${currentStep===1 ? "":"mb-[68.5px]"}`}>
