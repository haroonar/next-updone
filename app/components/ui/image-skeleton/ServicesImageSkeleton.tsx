...
const ServiceImageWithSkeleton: React.FC<ServiceImageWithSkeletonProps> = ({ src, alt, width, height,isHeroImg }) => {
  ...
  return (
    ...
    <div style={ { height}} >
      {!isLoaded && <Skeleton width={width} height={height}  className='animate-pulse bg-gray-50' />}
      <Image
